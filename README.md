...
```powershell
dotnet user-secrets set "ConnectionStrings:GameStoreContext" "Server=localhost; Database=GameStore; User Id=sa; Password=Password1.;TrustServerCertificate=True;"
```
